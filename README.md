...
|        프로젝트 세팅<br />인프라 구축<br />마일스톤 관리<br />핵심 기능 분리 및 정리<br />자료 조사, API 명세서 작성<br />서버 초기 세팅<br />투자 계좌 생성 / 출금 / 계좌정보 조회 / 거래내역 조회 API 개발<br />회원 정보 조회 API 개발<br />입출금 계좌 정보 조회 / 거래내역 조회 / 송금 API 개발<br />시스템 아키텍처 설계<br />CI 설정과 인프라 구축<br />개발 컨벤션 제작<br />기능 명세서 작성|       프로젝트 셋팅<br/> Directory 초기 구조 구축<br />- IA 작성, JIRA 일정 관리<br />목표, 반려일지, 챗봇 관련 ERD 작성 및 DB 설계<br />API 명세서 작성<br /> 반려동물 일지 등록, 조회 API 개발<br />저축목표 등록 / 송금 / 출금 / 삭제 / 요약 / 조회 / 상세내역 리스트 조회 API 개발<br />멍이냥 챗봇 모듈 개발 (OpenAI Assistant 사용) <br /> 챗봇 세션 입장 / 대화 API 개발 <br />공통 API 예외 처리 로직 개발 <br /> 프로젝트 초기 폴더 구조 생성 |   프로젝트 세팅<br /> ERD 수정 및 데이터 수정<br />기능 명세서 관리<br />반려동물 관리, 보험, 회원관리 관련 ERD 작성 및 DB 설계<br />반려동물 정보 등록 / 조회 / 수정 API 개발<br />반려동물 관련 보험 데이터 수집 및 보험 상세 정보 조회 API 개발<br />회원 로그인 / 회원가입 / 이메일 중복체크 API 개발<br />계좌 커스텀 이미지 수정 API 개발<br />이미지 업로드를 위한 S3 저장소 생성 및 백엔드 로직과 연결<br />계좌 거래 내역을 이용한 소비 내역 분석 로직 구현 |  
