...
|        <br />프로젝트 세팅<br /><br />인프라 구축<br /><br />마일스톤 관리<br /><br />핵심 기능 분리 및 정리<br /><br />자료 조사, API 명세서 작성<br /><br />서버 초기 세팅<br /><br />투자 계좌 생성 / 출금 / 계좌정보 조회 / 거래내역 조회 API 개발<br /><br />회원 정보 조회 API 개발<br /><br />입출금 계좌 정보 조회 / 거래내역 조회 / 송금 API 개발<br /><br />시스템 아키텍처 설계<br /><br />CI 설정과 인프라 구축<br /><br />개발 컨벤션 제작<br /><br />기능 명세서 작성        |        프로젝트 세팅<br /><br/> 프로젝트 초기 폴더 구조 구축 <br /><br /> 공통 API 응답 처리 로직 및 공통 API 예외 처리 로직 개발 <br /><br /> 프로젝트 IA 작성 <br /><br /> JIRA 일정 관리<br /><br />반려동물 투자 목표, 반려일지, 챗봇 관련 ERD 작성 및 DB 설계<br /><br />API 명세서 작성<br /><br /> 반려동물 일지 등록, 조회 API 개발<br /><br />저축목표 등록 / 송금 / 출금 / 삭제 / 요약 / 조회 / 상세내역 리스트 조회 API 개발<br /><br />멍이냥 챗봇 모듈 개발 (OpenAI Assistant 사용) <br /><br /> 챗봇 세션 입장 / 대화 API 개발        |        프로젝트 세팅<br /><br /> ERD 수정 및 데이터 수정<br /><br />기능 명세서 관리<br /><br />반려동물 관리, 보험, 회원관리 관련 ERD 작성 및 DB 설계<br /><br />반려동물 정보 등록 / 조회 / 수정 API 개발<br /><br />반려동물 관련 보험 데이터 수집 및 보험 상세 정보 조회 API 개발<br /><br />회원 로그인 / 회원가입 / 이메일 중복체크 API 개발<br /><br />계좌 커스텀 이미지 수정 API 개발<br /><br />이미지 업로드를 위한 S3 저장소 생성 및 백엔드 로직과 연결<br /><br />계좌 거래 내역을 이용한 소비 내역 분석 로직 구현        |  
