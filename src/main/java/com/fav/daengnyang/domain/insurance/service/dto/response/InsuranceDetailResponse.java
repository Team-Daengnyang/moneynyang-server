...
public class InsuranceDetailResponse {
    ...
    @Builder
    private InsuranceDetailResponse(Long insuranceId, String petType, String title, String companyImage, String url, String price, String comment, String summary) {
